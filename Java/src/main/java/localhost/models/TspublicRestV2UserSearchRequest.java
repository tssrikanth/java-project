...
public class TspublicRestV2UserSearchRequest {
    ...
    public String toString() {
        return "TspublicRestV2UserSearchRequest [" + "name=" + name + ", id=" + id
                + ", displayName=" + displayName + ", visibility=" + visibility + ", mail=" + mail
                + ", groups=" + groups + ", privileges=" + privileges + ", state=" + state
    ...
    public static class Builder {
        ...
        public TspublicRestV2UserSearchRequest build() {
            return new TspublicRestV2UserSearchRequest(name, id, displayName, visibility, mail,
                    groups, privileges, state, notifyOnShare, showWalkMe, analystOnboardingComplete,
                    type);
        }
    }
}
