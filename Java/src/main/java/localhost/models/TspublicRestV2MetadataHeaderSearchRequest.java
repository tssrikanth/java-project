...
public class TspublicRestV2MetadataHeaderSearchRequest {
    ...
    public String toString() {
        return "TspublicRestV2MetadataHeaderSearchRequest [" + "type=" + type + ", outputFields="
                ...
                + accessLevel + ", tag=" + tag + ", favoriteFor=" + favoriteFor + ", createdBy="
                + createdBy + ", lastModifiedBy=" + lastModifiedBy + ", ownedBy=" + ownedBy + "]";
    }
    ...
    public static class Builder {
        ...
        public TspublicRestV2MetadataHeaderSearchRequest build() {
            return new TspublicRestV2MetadataHeaderSearchRequest(type, outputFields, offset,
                    ...
                    showHidden, autoCreated, accessLevel, tag, favoriteFor, createdBy,
